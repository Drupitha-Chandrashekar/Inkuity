  ...
  return (
    <>
      <style>{`
        ...
        /* Floating decorative squares (same as landing page) */
        .floating-square {
          position: absolute;
          width: 50px;
          height: 50px;
        ...
        .square1 { top: 10%; left: 15%; animation-delay: 0s; }
        .square2 { top: 20%; left: 75%; animation-delay: 2s; }
        .square3 { top: 70%; left: 25%; animation-delay: 4s; }
